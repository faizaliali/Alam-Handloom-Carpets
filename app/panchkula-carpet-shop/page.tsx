export const metadata = {
  title: "Best Carpet Shop in Panchkula | Alam Handloom Carpets",
  description:
    "Premium Handknotted Carpet, Kashmiri Silk Carpet, Hand Tufted Carpet, Iranian Carpet, Turkish Carpet and Modern Carpets for customers in Panchkula and nearby areas.",
};
...
<section className="relative bg-[url('/images/Hero-carpet.jpeg')] bg-cover bg-center bg-no-repeat text-white py-24 px-6">
  ...
  <div className="relative max-w-6xl mx-auto text-center">
    ...
    <h1 className="text-5xl font-bold mb-6">
      Best Carpet Shop Serving Panchkula
    </h1>
    ...
    <p className="text-sm mt-4 text-gray-200">
      Serving Panchkula, Chandigarh, Mohali, Zirakpur & nearby areas with luxury carpets
    </p>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold mb-6">
              Premium Carpet Collections for Panchkula
            </h2>
    ...
    >
      ...
      <section className="bg-gray-100 py-20 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-bold mb-6">
            Serving Panchkula and Nearby Areas
          </h2>

          <p className="text-lg leading-8 text-gray-700">
            Alam Handloom Carpets serves customers in Panchkula
