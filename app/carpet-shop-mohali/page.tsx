      ...
      <section className="bg-black text-white py-20 px-6">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto leading-8">
            ...
            Turkey carpets, Iranian Carpet and modern carpets for customers in Mohali.
          </p>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold mb-6">
              Premium Carpet Collections for Mohali
            </h2>
    ...
    >
      ...
      <section className="bg-gray-100 py-20 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-bold mb-6">
            Serving Mohali and Nearby Areas
          </h2>

          <p className="text-lg leading-8 text-gray-700">
            Alam Handloom Carpets serves customers in Mohali
