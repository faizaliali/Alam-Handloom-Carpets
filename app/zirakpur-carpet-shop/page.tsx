export const metadata = {
  title: "Best Carpet Shop in Zirakpur | Alam Handloom Carpets",
  description:
    "Premium Handknotted Carpet, Kashmiri Silk Carpet, Hand Tufted Carpet, Iranian Carpet, Turkish Carpet and Modern Carpets for customers in Zirakpur and nearby areas.",
};
...
<section className="relative bg-[url('/images/Hero-carpet.jpeg')] bg-cover bg-center bg-no-repeat text-white py-24 px-6">
  ...
  <div className="relative max-w-6xl mx-auto text-center">
    ...
    <h1 className="text-5xl font-bold mb-6">
      Best Carpet Shop Serving Zirakpur
    </h1>

    <p className="text-xl max-w-3xl mx-auto leading-8">
      Alam Handloom Carpets provides premium handknotted carpets,
      Kashmiri silk carpets, Turkish carpets,
      Iranian carpets, hand tufted carpets and modern carpets for customers in Zirakpur.
    </p>

    {/* LOCAL SEO SIGNAL */}
    <p className="text-sm mt-4 text-gray-200">
      Serving Zirakpur, Chandigarh, Mohali, Panchkula & nearby areas with luxury handmade carpets
    </p>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold mb-6">
              Premium Carpet Collections for Zirakpur
            </h2>
            ...
            <p className="text-lg leading-8 text-gray-700">
              ...
              offices and hotels in Zirakpur.
            </p>
    ...
    >
      ...
      <section className="bg-gray-100 py-20 px-6">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-4xl font-bold mb-6">
            Serving Zirakpur and Nearby Areas
          </h2>

          <p className="text-lg leading-8 text-gray-700">
            Alam Handloom Carpets serves customers in Zirakpur
            from our Chandigarh carpet store with premium carpet collections.
          </p>
